...
def send_email(send_email, subject, smtp, from_user, pwd, to, cc, total, passed, failed, percentage, exe_date,
    ...
    if send_email:
        ...
        dir_path = "/Users/cdhingra/PycharmProjects/sshlibrary/Metrics/"
        logfile = ["log-20221010-122614.html", "report-20221010-122614.html", "metrics-20221014-161623.html"]
        ...
        <body>
            <div class="rf-box">
                ...
                <p style="padding-left:20px">
                    Hi Team,<br>
                    Following are the last build execution result. Please refer the above metrics for more info
                </p>
